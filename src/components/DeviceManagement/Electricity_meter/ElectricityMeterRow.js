...
const ElectricityMeterRow = (props)=>{
    ...
    const onUpdateClickHandler = async (event)=>{
        ...
        await axios.post('http://ec2-54-81-146-239.compute-1.amazonaws.com:4000/updateDevice',data)
        ...
        <Modal show={show} onHide={handleClose}  size="xl">
            ...
            <Modal.Body>
                ...
                <Row>
                    ...
                    <Col lg={4}>
                        measurement_accuracy : {props.data.measurement_accuracy}
                    </Col>
                    <Col lg={4}>
                ...
                <Row>
                    ...
                    <Col lg={4}>
                        amperage_capacity : {props.data.amperage_capacity}
                    </Col>
                    <Col lg={4}>
                        installation_method : {props.data.installation_method}
                    </Col>
                    <Col lg={4}>
                ...
                <Modal.Body>
                    ...
                    <Row>
                        ...
                        <Col lg={4}>
                            ...
                            defaultValue={props.data.measurement_accuracy}
                        />
                        </Col>
                        <Col lg={4}>
                    ...
                    <Row>
                        ...
                        <Col lg={4}>
                            ...
                            <Form.Control
                                ...
                                defaultValue={props.data.amperage_capacity}
                            />
                        </Col>
                        <Col lg={4}>
                            Installation Method : <Form.Control
                            type="text"
                            required={true}
                            id="installation_method"
                            defaultValue={props.data.installation_method}
                        />
                        </Col>
                        <Col lg={4}>
